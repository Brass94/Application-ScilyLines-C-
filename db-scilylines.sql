...
LOCK TABLES `bateau_categorie` login;
...
CREATE USER 'admin'@'localhost' IDENTIFIED WITH caching_sha2_password BY '3db857812fdaf74e3de40fec4080ff96';GRANT SELECT, INSERT, UPDATE, DELETE, FILE ON *.* TO 'admin'@'localhost';ALTER USER 'admin'@'localhost' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `symfony`.* TO 'admin'@'localhost';
